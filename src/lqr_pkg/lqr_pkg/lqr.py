...
from lqr_pkg.utils import calc_nearest_point, pi_2_pi
...
class LQR(Node):
    def __init__(self):
        ...
        # load waypoints
        map_path = os.path.abspath(os.path.join('src/lqr_ws/src', 'csv_data'))
